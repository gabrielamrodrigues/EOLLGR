...
theta80_cens10 <- theta

save(list = "theta80_cens10",
     file = "results/results_10/theta80_cens10.Rda",
     compress = "xz")

se80_cens10 <- se
p80_cens10 <- se2

save(list = "se80_cens10",
     file = "results/results_10/se80_cens10.Rda",
     compress = "xz")

save(list = "p80_cens10",
     file = "results/results_10/p80_cens10.Rda",
     compress = "xz")

cens.vector80.10 <- cens.vector

save(list = "cens.vector80.10",
     file = "results/results_10/cens.vector80.10.Rda",
     compress = "xz")

c.eollgr80.10 <- c.eollgr.train
c.forest80.10 <- data.frame(c.forest.train2,c.forest.train3,c.forest.train4)

save(list = "c.forest80.10",
     file = "results/results_10/c.forest80.10.Rda",
     compress = "xz")

save(list = "c.eollgr80.10",
     file = "results/results_10/c.eollgr80.10.Rda",
     compress = "xz")


error80_cens102 <- data.error.comp2
error80_cens103 <- data.error.comp3
error80_cens104 <- data.error.comp4

save(list = "error80_cens102",
     file = "results/results_10/error80_cens102.Rda",
     compress = "xz")

save(list = "error80_cens103",
     file = "results/results_10/error80_cens103.Rda",
     compress = "xz")

save(list = "error80_cens104",
     file = "results/results_10/error80_cens104.Rda",
     compress = "xz")
...
theta150_cens10 <- theta

save(list = "theta150_cens10",
     file = "results/results_10/theta150_cens10.Rda",
     compress = "xz")

se150_cens10 <- se
p150_cens10 <- se2

save(list = "se150_cens10",
     file = "results/results_10/se150_cens10.Rda",
     compress = "xz")

save(list = "p150_cens10",
     file = "results/results_10/p150_cens10.Rda",
     compress = "xz")

cens.vector150.10 <- cens.vector

save(list = "cens.vector150.10",
     file = "results/results_10/cens.vector150.10.Rda",
     compress = "xz")

c.eollgr150.10 <- c.eollgr.train
c.forest150.10 <- data.frame(c.forest.train2,c.forest.train3,c.forest.train4)

save(list = "c.forest150.10",
     file = "results/results_10/c.forest150.10.Rda",
     compress = "xz")

save(list = "c.eollgr150.10",
     file = "results/results_10/c.eollgr150.10.Rda",
     compress = "xz")


error150_cens102 <- data.error.comp2
error150_cens103 <- data.error.comp3
error150_cens104 <- data.error.comp4

save(list = "error150_cens102",
     file = "results/results_10/error150_cens102.Rda",
     compress = "xz")

save(list = "error150_cens103",
     file = "results/results_10/error150_cens103.Rda",
     compress = "xz")

save(list = "error150_cens104",
     file = "results/results_10/error150_cens104.Rda",
     compress = "xz")
...
theta450_cens10 <- theta

save(list = "theta450_cens10",
     file = "results/results_10/theta450_cens10.Rda",
     compress = "xz")

se450_cens10 <- se
p450_cens10 <- se2

save(list = "se450_cens10",
     file = "results/results_10/se450_cens10.Rda",
     compress = "xz")

save(list = "p450_cens10",
     file = "results/results_10/p450_cens10.Rda",
     compress = "xz")

cens.vector450.10 <- cens.vector

save(list = "cens.vector450.10",
     file = "results/results_10/cens.vector450.10.Rda",
     compress = "xz")

c.eollgr450.10 <- c.eollgr.train
c.forest450.10 <- data.frame(c.forest.train2,c.forest.train3,c.forest.train4)

save(list = "c.forest450.10",
     file = "results/results_10/c.forest450.10.Rda",
     compress = "xz")

save(list = "c.eollgr450.10",
     file = "results/results_10/c.eollgr450.10.Rda",
     compress = "xz")


error450_cens102 <- data.error.comp2
error450_cens103 <- data.error.comp3
error450_cens104 <- data.error.comp4

save(list = "error450_cens102",
     file = "results/results_10/error450_cens102.Rda",
     compress = "xz")

save(list = "error450_cens103",
     file = "results/results_10/error450_cens103.Rda",
     compress = "xz")

save(list = "error450_cens104",
     file = "results/results_10/error450_cens104.Rda",
     compress = "xz")

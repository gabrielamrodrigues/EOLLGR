...
# plot(gg_error(fit.forest4))


theta80_cens0 <- theta

save(list = "theta80_cens0",
     file = "results/results_0/theta80_cens0.Rda",
     compress = "xz")

se80_cens0 <- se
p80_cens0 <- se2

save(list = "se80_cens0",
     file = "results/results_0/se80_cens0.Rda",
     compress = "xz")

save(list = "p80_cens0",
     file = "results/results_0/p80_cens0.Rda",
     compress = "xz")

cens.vector80.0 <- cens.vector

save(list = "cens.vector80.0",
     file = "results/results_0/cens.vector80.0.Rda",
     compress = "xz")

c.eollgr80.0 <- c.eollgr.train
c.forest80.0 <- data.frame(c.forest.train2,c.forest.train3,c.forest.train4)

save(list = "c.forest80.0",
     file = "results/results_0/c.forest80.0.Rda",
     compress = "xz")

save(list = "c.eollgr80.0",
     file = "results/results_0/c.eollgr80.0.Rda",
     compress = "xz")


error80_cens02 <- data.error.comp2
error80_cens03 <- data.error.comp3
error80_cens04 <- data.error.comp4

save(list = "error80_cens02",
     file = "results/results_0/error80_cens02.Rda",
     compress = "xz")

save(list = "error80_cens03",
     file = "results/results_0/error80_cens03.Rda",
     compress = "xz")

save(list = "error80_cens04",
     file = "results/results_0/error80_cens04.Rda",
     compress = "xz")
...
theta150_cens0 <- theta

save(list = "theta150_cens0",
     file = "results/results_0/theta150_cens0.Rda",
     compress = "xz")

se150_cens0 <- se
p150_cens0 <- se2

save(list = "se150_cens0",
     file = "results/results_0/se150_cens0.Rda",
     compress = "xz")

save(list = "p150_cens0",
     file = "results/results_0/p150_cens0.Rda",
     compress = "xz")

cens.vector150.0 <- cens.vector

save(list = "cens.vector150.0",
     file = "results/results_0/cens.vector150.0.Rda",
     compress = "xz")

c.eollgr150.0 <- c.eollgr.train
c.forest150.0 <- data.frame(c.forest.train2,c.forest.train3,c.forest.train4)

save(list = "c.forest150.0",
     file = "results/results_0/c.forest150.0.Rda",
     compress = "xz")

save(list = "c.eollgr150.0",
     file = "results/results_0/c.eollgr150.0.Rda",
     compress = "xz")


error150_cens02 <- data.error.comp2
error150_cens03 <- data.error.comp3
error150_cens04 <- data.error.comp4

save(list = "error150_cens02",
     file = "results/results_0/error150_cens02.Rda",
     compress = "xz")

save(list = "error150_cens03",
     file = "results/results_0/error150_cens03.Rda",
     compress = "xz")

save(list = "error150_cens04",
     file = "results/results_0/error150_cens04.Rda",
     compress = "xz")
...
theta450_cens0 <- theta

save(list = "theta450_cens0",
     file = "results/results_0/theta450_cens0.Rda",
     compress = "xz")

se450_cens0 <- se
p450_cens0 <- se2

save(list = "se450_cens0",
     file = "results/results_0/se450_cens0.Rda",
     compress = "xz")

save(list = "p450_cens0",
     file = "results/results_0/p450_cens0.Rda",
     compress = "xz")

cens.vector450.0 <- cens.vector

save(list = "cens.vector450.0",
     file = "results/results_0/cens.vector450.0.Rda",
     compress = "xz")

c.eollgr450.0 <- c.eollgr.train
c.forest450.0 <- data.frame(c.forest.train2,c.forest.train3,c.forest.train4)

save(list = "c.forest450.0",
     file = "results/results_0/c.forest450.0.Rda",
     compress = "xz")

save(list = "c.eollgr450.0",
     file = "results/results_0/c.eollgr450.0.Rda",
     compress = "xz")


error450_cens02 <- data.error.comp2
error450_cens03 <- data.error.comp3
error450_cens04 <- data.error.comp4

save(list = "error450_cens02",
     file = "results/results_0/error450_cens02.Rda",
     compress = "xz")

save(list = "error450_cens03",
     file = "results/results_0/error450_cens03.Rda",
     compress = "xz")

save(list = "error450_cens04",
     file = "results/results_0/error450_cens04.Rda",
     compress = "xz")
